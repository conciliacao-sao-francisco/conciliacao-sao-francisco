...
# Tenta importar o leitor de PDF obrigatório para as contas poupança
try:
    import pypdf
except ImportError:
    pypdf = None
    ...
    if df_banco_orig is not None and not df_banco_orig.empty:
        ...
        with aba_conciliacao:
            ...
            with col1:
                ...
                selecionados_banco = []
                if df_banco_tela.empty: st.success("✅ Tudo liquidado no banco neste dia!")
            ...
            with col2:
                ...
                if df_sistema_tela.empty: st.success("✅ Nenhum lançamento pendente no sistema hoje.")
